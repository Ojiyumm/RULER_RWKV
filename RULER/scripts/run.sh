...
ROOT_DIR="/home/rwkv/Peter/RULER/scripts/results" # the path that stores generated task samples and model predictions. 
MODEL_DIR="/home/rwkv/Peter/hf_models/RWKV_v5-EagleX-v2-7B-HF" # the path that contains individual model folders from HUggingface.
